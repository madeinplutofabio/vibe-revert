...
//
// 5. **No CLI-typed errors.** Core cannot import the CLI's
...
//
// 6. **Helpers duplicated with @viberevert/git/src/ids.ts.** The
...
// =============================================================================
// Duplicated helpers (mirror in @viberevert/git/src/ids.ts; keep byte-identical)
// =============================================================================
 ...
 * subseed `core:session`. See the file header for the full env-var
 * contract.
 */
export function generateSessionId(): string {
  return `sess_${getFactory("core:session")()}`;
}
 ...
 * Under `VIBEREVERT_TEST_FIXED_ULID_SEED` (per D49 Precondition 2),
 * this factory produces a deterministic ULID sequence keyed on the
 * subseed `core:report`. See the file header for the full env-var
 * contract.
 */
